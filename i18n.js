...
const UI = {
  he: {
    ...
    tierCourseDesc: "פתיחת קורס אימון אחד לבחירתך.",
    tierPremiumName: "Premium",
    tierPremiumDesc: "כל הקורסים + כל המתכונים המיוחדים (וגם יותר בעתיד).",
    lockedRecipeTitle: "מתכון מיוחד 🔒",
    lockedRecipeText: "המתכון הזה נעול. שדרגו ל-Premium כדי לפתוח את כל המתכונים המיוחדים.",
  ...
  en: {
    ...
    tierCourseDesc: "Unlock one training course of your choice.",
    tierPremiumName: "Premium",
    tierPremiumDesc: "All courses + all special recipes (and more coming).",
    lockedRecipeTitle: "Special recipe 🔒",
    lockedRecipeText: "This recipe is locked. Upgrade to Premium to unlock all special recipes.",
